...
const lintCssTask = createTask({
  ...
  call: task.lintCss([...glob.css, `!${srcDir}/css/font-awesome/**`]),
})
...
const copyFontawesomeTask = createTask({
  name: 'copy-fontawesome',
  desc: 'copy sources',
  call: series(
    task.copy(`${srcDir}/css/font-awesome/*`, `${destDir}/css/font-awesome`),
    task.copy(`${srcDir}/css/font-awesome/fonts/*`, `${destDir}/css/fonts`)
  ),
  // call: src(`${srcDir}/css/font-awesome/**/*`, { base: srcDir }).pipe(dest(`${destDir}/css/font-awesome/**/*`)),
})

const bundleBuildTask = createTask({
  name: 'bundle:build',
  call: series(cleanTask, lintTask, buildTask, copyFontawesomeTask),
})
