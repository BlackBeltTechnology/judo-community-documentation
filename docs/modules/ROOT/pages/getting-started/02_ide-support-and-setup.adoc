...
Installation instructions could be found in the plugin's https://github.com/BlackBeltTechnology/judo-jsl-vscode/blob/develop/README.adoc[Github Repository,window=_blank].