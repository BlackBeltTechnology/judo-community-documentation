...
In this example we can see that the modeled `totalNumberOfLeads` query resulted in the `getTotalNumberOfLeads()` being added
to the dedicated DAO `TotalNumberOfLeads.TotalNumberOfLeadsDao`.