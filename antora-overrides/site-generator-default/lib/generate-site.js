...
/**
 * ========================================
 * OVERRIDES Antora source in node_modules!
 * "@antora/site-generator-default": "2.3"
 * ========================================
 */

const generateIndex = require('antora-lunr') // manual addition
...
async function generateSite (args, env) {
  ...
  const index = generateIndex(playbook, pages, contentCatalog, env) // manual addition
  siteFiles.push(generateIndex.createIndexFile(index)) // manual addition
